...
function resetForm() {
  ...
  return (
    <div className="mx-auto p-3 my-3 shadow-sm rounded-md border-slate-600 bg-gray-50">
      {!isOpenModel && (
        <div onClick={handleModel} className="toggle bg-gray-50 my-2 border-b-1 border-gray-200">
          <input
            type="text"

            placeholder="what's on your mind?"
            className=" cursor-pointer bg-transparent border-0 border-b border-gray-200 placeholder:text-slate-700 w-full"
          />
        </div>
      )}
      {isOpenModel && (
          ...
          <div className="flex justify-between items-center my-2">
            ...
            <div className="flex gap-2">
              <button
                ...
                type="button"
                className=" cursor-pointer focus:outline-none text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-none text-sm px-5 py-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900"
              >
                Cancel
              </button>
              <button
                type="button"
                onClick={mutate}
                className="cursor-pointer focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-transparent font-medium  text-sm px-6 py-2 mb-2 rounded-none dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
              >
