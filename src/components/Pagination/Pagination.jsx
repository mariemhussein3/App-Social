...
export default function Pagination({setPageNumber}) {
  return (
          <nav aria-label="Page navigation example">
  <ul className="flex items-center -space-x-px h-8 text-sm fixed bottom-2.5 start-1/2 -translate-x-1/2">
    <li>
