...
{isOpen && (
    <div className="bg-white p-6 rounded-lg shadow-lg w-[40%]  fixed  z-50 top-[30%] left-1/2 -translate-x-1/2 flexitems-center justify-center">
    ...
    <h2> Upload Photo</h2>
      ...
      >
       <i
                  className="fa-solid fa-x cursor-pointer text-[12px]  text-slate-700"
                ></i>
      </button>
